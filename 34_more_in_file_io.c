...
int main(){
    ...
    */
    ...
    FILE* file_pointer_read = fopen("34_file_io_read.txt", "r");
    ...
    FILE* file_pointer_write = fopen("34_file_io_write.txt", "w");
    ...
    FILE* file_pointer_append = fopen("34_file_io_append.txt", "a");
    ...
    FILE* file_pointer_r_plus = fopen("34_file_io_r_plus.txt", "r+");
    ...
    FILE* file_pointer_w_plus = fopen("34_file_io_w_plus.txt", "w+");
    ...
    FILE* file_pointer_a_plus = fopen("34_file_io_a_plus.txt", "a+");
